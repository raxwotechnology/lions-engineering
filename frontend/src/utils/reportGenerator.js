...
export const generatePDFReport = ({ title, columns, data, filename }) => {
  ...
  const drawReportContent = (logoBase64, imgW = 0, imgH = 0) => {
    ...
    doc.text('Lions Engineering', textStartX, 20);
    ...
    doc.text('Email: info@lions-engineering.com', pageWidth - 14, 26, { align: 'right' });
    ...
    autoTable(doc, {
      ...
      didDrawPage: (hookData) => {
        ...
        doc.text('Lions Engineering - Confidential Report', 14, pageHeight - 10);
...
export const generateInvoicePDF = (data, type = 'invoice') => {
  ...
  doc.setFont('helvetica', 'bold');
  doc.text('Lions Engineering', 14, 20);
